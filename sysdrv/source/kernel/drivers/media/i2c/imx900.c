...
#define IMX900_10BIT_HDR2_PIXEL_RATE	(MIPI_FREQ_594M * 2 / 10 * 4)
#define IMX900_XVCLK_FREQ_54M		54000000

#define CHIP_ID				0x06
#define IMX900_REG_CHIP_ID		0x3057

#define IMX900_REG_CTRL_MODE		0x3000
#define IMX900_MODE_SW_STANDBY		BIT(0)
#define IMX900_MODE_STREAMING		0x0

#define IMX900_REG_MARSTER_MODE		0x3002
#define IMX900_MODE_STOP		BIT(0)
#define IMX900_MODE_START		0x0

#define IMX900_GAIN_SWITCH_REG		0x3019

#define IMX900_LF_GAIN_REG_H		0x30E9
#define IMX900_LF_GAIN_REG_L		0x30E8

#define IMX900_SF1_GAIN_REG_H		0x30EB
#define IMX900_SF1_GAIN_REG_L		0x30EA

#define IMX900_SF2_GAIN_REG_H		0x30ED
#define IMX900_SF2_GAIN_REG_L		0x30EC

#define IMX900_LF_EXPO_REG_H		0x305A
#define IMX900_LF_EXPO_REG_M		0x3059
#define IMX900_LF_EXPO_REG_L		0x3058

#define IMX900_SF1_EXPO_REG_H		0x305E
#define IMX900_SF1_EXPO_REG_M		0x305D
#define IMX900_SF1_EXPO_REG_L		0x305C

#define IMX900_SF2_EXPO_REG_H		0x3062
#define IMX900_SF2_EXPO_REG_M		0x3061
#define IMX900_SF2_EXPO_REG_L		0x3060
#define IMX900_RHS1_DEFAULT		0x06d
#define IMX900_RHS1_X3_DEFAULT		0x0a3

#define IMX900_RHS1_REG_H		0x306a
#define IMX900_RHS1_REG_M		0x3069
#define IMX900_RHS1_REG_L		0x3068

#define IMX900_RHS2_REG_H		0x306E
#define IMX900_RHS2_REG_M		0x306D
#define IMX900_RHS2_REG_L		0x306C
#define IMX900_RHS2_X3_DEFAULT		0x0ce


#define	IMX900_EXPOSURE_MIN		2
...
#define IMX900_FETCH_GAIN_H(VAL)	(((VAL) >> 8) & 0x07)
...
#define IMX900_FETCH_RHS1_H(VAL)	(((VAL) >> 16) & 0x0F)
#define IMX900_FETCH_RHS1_M(VAL)	(((VAL) >> 8) & 0xFF)
#define IMX900_FETCH_RHS1_L(VAL)	((VAL) & 0xFF)

#define IMX900_FETCH_VTS_H(VAL)		(((VAL) >> 16) & 0x0F)
#define IMX900_FETCH_VTS_M(VAL)		(((VAL) >> 8) & 0xFF)
#define IMX900_FETCH_VTS_L(VAL)		((VAL) & 0xFF)

#define IMX900_GROUP_HOLD_REG		0x3001
#define IMX900_GROUP_HOLD_START		0x01
#define IMX900_GROUP_HOLD_END		0x00

#define IMX900_VTS_REG_L		0x3030
#define IMX900_VTS_REG_M		0x3031
#define IMX900_VTS_REG_H		0x3032

#define REG_NULL			0xFFFF

#define IMX900_REG_VALUE_08BIT		1
#define IMX900_REG_VALUE_16BIT		2
#define IMX900_REG_VALUE_24BIT		3

#define IMX900_BITS_PER_SAMPLE		10

#define IMX900_VREVERSE_REG	0x304f
#define IMX900_HREVERSE_REG	0x304e
...
struct IMX900 {
	...
	bool			power_on;
	bool			has_init_exp;
	const struct IMX900_mode *support_modes;
 ...
 * Xclk 37.125Mhz
 */
static const struct regval IMX900_global_regs[] = {
	{REG_NULL, 0x00},
};

static __maybe_unused const struct regval IMX900_linear_10bit_2688x1520_2lane_37m_regs[] = {
	{0x3000, 0x01},
	{0x3002, 0x01},
	{0x300C, 0x5B},
	{0x300D, 0x40},
...
static __maybe_unused const struct regval IMX900_hdr_2x_10bit_2688x1520_2lane_37m_regs[] = {
	{0x3000, 0x01},
	{0x3002, 0x01},
	{0x300C, 0x5B},
	{0x300D, 0x40},
...
static const struct regval IMX900_linear_10bit_2688x1520_2lane_regs[] = {
	{0x3000, 0x01},
	{0x3002, 0x01},
	{0x300C, 0x3b},
	{0x300D, 0x2a},
...
static const struct regval IMX900_hdr_2x_10bit_2688x1520_2lane_regs[] = {
	{0x3000, 0x01},
	{0x3002, 0x01},
	{0x300C, 0x3B},
	{0x300D, 0x2A},
...
static const struct regval IMX900_linear_10bit_2688x1520_regs[] = {
	{0x3000, 0x01},
	{0x3002, 0x01},
	{0x300C, 0x5B},
	{0x300D, 0x40},
...
static const struct regval IMX900_hdr_2x_10bit_2688x1520_regs[] = {
	{0x3000, 0x01},
	{0x3002, 0x01},
	{0x300C, 0x5B},
	{0x300D, 0x40},
...
static const struct regval IMX900_hdr_3x_10bit_2688x1520_regs[] = {
	{0x3000, 0x01},
	{0x3002, 0x01},
	{0x300C, 0x5B},
	{0x300D, 0x40},
...
static __maybe_unused const struct regval IMX900_linear_12bit_2688x1520_regs[] = {
	{0x3000, 0x01},
	{0x3002, 0x00},
	{0x300C, 0x3B},
	{0x300D, 0x2A},
...
static __maybe_unused const struct regval IMX900_hdr_2x_12bit_2688x1520_regs[] = {
	{0x3000, 0x01},
	{0x3002, 0x00},
	{0x300C, 0x3B},
	{0x300D, 0x2A},
...
static __maybe_unused const struct regval IMX900_interal_sync_master_start_regs[] = {
	{0x3010, 0x07},
	{0x31a1, 0x00},
	{REG_NULL, 0x00},
};
static __maybe_unused const struct regval IMX900_interal_sync_master_stop_regs[] = {
	{0x31a1, 0x0f},
	{REG_NULL, 0x00},
};

static __maybe_unused const struct regval IMX900_external_sync_master_start_regs[] = {
	{0x3010, 0x05},
	{0x31a1, 0x03},
	{0x31d9, 0x01},
	{REG_NULL, 0x00},
};
static __maybe_unused const struct regval IMX900_external_sync_master_stop_regs[] = {
	{0x31a1, 0x0f},
	{REG_NULL, 0x00},
};

static __maybe_unused const struct regval IMX900_slave_start_regs[] = {
	{0x3010, 0x05},
	{0x31a1, 0x0f},
	{REG_NULL, 0x00},
};
...
static const struct IMX900_mode supported_modes[] = {
	{
		...
		.bpp = 10,
		.mclk = 37125000,
		.reg_list = IMX900_linear_10bit_2688x1520_regs,
		.hdr_mode = NO_HDR,
	...
	},
	{
		...
		.bpp = 10,
		.mclk = 37125000,
		.reg_list = IMX900_hdr_2x_10bit_2688x1520_regs,
		.hdr_mode = HDR_X2,
	...
	},
	{
		...
		.bpp = 10,
		.mclk = 37125000,
		.reg_list = IMX900_hdr_3x_10bit_2688x1520_regs,
		.hdr_mode = HDR_X3,
...
static const struct IMX900_mode supported_modes_2lane[] = {
	{
		...
		.bpp = 10,
		.mclk = 24000000,
		.reg_list = IMX900_linear_10bit_2688x1520_2lane_regs,
		.hdr_mode = NO_HDR,
		.vc[PAD0] = V4L2_MBUS_CSI2_CHANNEL_0,
	},
	{
		...
		.bpp = 10,
		.mclk = 24000000,
		.reg_list = IMX900_hdr_2x_10bit_2688x1520_2lane_regs,
		.hdr_mode = HDR_X2,
		.vc[PAD0] = V4L2_MBUS_CSI2_CHANNEL_1,
		.vc[PAD1] = V4L2_MBUS_CSI2_CHANNEL_0,//L->csi wr0
		.vc[PAD2] = V4L2_MBUS_CSI2_CHANNEL_1,
...
static const struct IMX900_mode *
IMX900_find_best_fit(struct IMX900 *IMX900, struct v4l2_subdev_format *fmt)
{
	...
	for (i = 0; i < IMX900->cfg_num; i++) {
		dist = IMX900_get_reso_dist(&IMX900->support_modes[i], framefmt);
		if ((cur_best_fit_dist == -1 || dist <= cur_best_fit_dist) &&
			IMX900->support_modes[i].bus_fmt == framefmt->code) {
			cur_best_fit_dist = dist;
			cur_best_fit = i;
		}
	}

	return &IMX900->support_modes[cur_best_fit];
}
	...
	if (fmt->which == V4L2_SUBDEV_FORMAT_TRY) {
		...
		*v4l2_subdev_get_try_format(sd, cfg, fmt->pad) = fmt->format;
		...
		pixel_rate = (u32)link_freq_menu_items[mode->mipi_freq_idx] / mode->bpp * 2 *
			     IMX900->bus_cfg.bus.mipi_csi2.num_data_lanes;
		__v4l2_ctrl_s_ctrl_int64(IMX900->pixel_rate,
					 pixel_rate);
		__v4l2_ctrl_s_ctrl(IMX900->link_freq,
				   mode->mipi_freq_idx);
	}
				 ...
				 struct v4l2_subdev_mbus_code_enum *code)
{
	...
	if (code->index != 0)
		return -EINVAL;
	code->code = IMX900->cur_mode->bus_fmt;
				   ...
				   struct v4l2_subdev_frame_size_enum *fse)
{
	...
	if (fse->code != IMX900->support_modes[fse->index].bus_fmt)
		return -EINVAL;

	fse->min_width  = IMX900->support_modes[fse->index].width;
	fse->max_width  = IMX900->support_modes[fse->index].width;
	fse->max_height = IMX900->support_modes[fse->index].height;
	fse->min_height = IMX900->support_modes[fse->index].height;
				...
				struct v4l2_mbus_config *config)
{
	...
	const struct IMX900_mode *mode = IMX900->cur_mode;
	u32 val = 0;
	u32 lane_num = IMX900->bus_cfg.bus.mipi_csi2.num_data_lanes;
...
static int IMX900_set_hdrae(struct IMX900 *IMX900,
			    struct preisp_hdrae_exp_s *ae)
{
	...
	u32 rhs1 = 0;
	u32 rhs1_max = 0;
	static int rhs1_old = IMX900_RHS1_DEFAULT;
	int rhs1_change_limit;
	int ret = 0;
	u32 fsc = IMX900->cur_vts;
	u8 cg_mode = 0;

	if (!IMX900->has_init_exp && !IMX900->streaming) {
		IMX900->init_hdrae_exp = *ae;
		IMX900->has_init_exp = true;
		dev_dbg(&IMX900->client->dev, "IMX900 don't stream, record exp for hdr!\n");
		return ret;
	}
	...
	if (IMX900->cur_mode->hdr_mode == HDR_X2) {
		//2 stagger
		l_a_gain = m_a_gain;
		l_exp_time = m_exp_time;
		cg_mode = ae->middle_cg_mode;
	}
	if (!IMX900->isHCG && cg_mode == GAIN_MODE_HCG) {
		gain_switch = 0x01 | 0x100;
		IMX900->isHCG = true;
	} else if (IMX900->isHCG && cg_mode == GAIN_MODE_LCG) {
		gain_switch = 0x00 | 0x100;
		IMX900->isHCG = false;
	}
	ret = IMX900_write_reg(client,
		IMX900_GROUP_HOLD_REG,
		IMX900_REG_VALUE_08BIT,
		IMX900_GROUP_HOLD_START);
	//gain effect n+1
	ret |= IMX900_write_reg(client,
		IMX900_LF_GAIN_REG_H,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_GAIN_H(l_a_gain));
	ret |= IMX900_write_reg(client,
		IMX900_LF_GAIN_REG_L,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_GAIN_L(l_a_gain));
	ret |= IMX900_write_reg(client,
		IMX900_SF1_GAIN_REG_H,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_GAIN_H(s_a_gain));
	ret |= IMX900_write_reg(client,
		IMX900_SF1_GAIN_REG_L,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_GAIN_L(s_a_gain));
	if (gain_switch & 0x100)
		ret |= IMX900_write_reg(client,
			IMX900_GAIN_SWITCH_REG,
			IMX900_REG_VALUE_08BIT,
			gain_switch & 0xff);
	/* Restrictions
	...
	ret |= IMX900_write_reg(client,
		IMX900_RHS1_REG_L,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_RHS1_L(rhs1));
	ret |= IMX900_write_reg(client,
		IMX900_RHS1_REG_M,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_RHS1_M(rhs1));
	ret |= IMX900_write_reg(client,
		IMX900_RHS1_REG_H,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_RHS1_H(rhs1));

	ret |= IMX900_write_reg(client,
		IMX900_SF1_EXPO_REG_L,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_EXP_L(shr1));
	ret |= IMX900_write_reg(client,
		IMX900_SF1_EXPO_REG_M,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_EXP_M(shr1));
	ret |= IMX900_write_reg(client,
		IMX900_SF1_EXPO_REG_H,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_EXP_H(shr1));
	ret |= IMX900_write_reg(client,
		IMX900_LF_EXPO_REG_L,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_EXP_L(shr0));
	ret |= IMX900_write_reg(client,
		IMX900_LF_EXPO_REG_M,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_EXP_M(shr0));
	ret |= IMX900_write_reg(client,
		IMX900_LF_EXPO_REG_H,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_EXP_H(shr0));
	ret |= IMX900_write_reg(client,
		IMX900_GROUP_HOLD_REG,
		IMX900_REG_VALUE_08BIT,
...
static int IMX900_set_hdrae_3frame(struct IMX900 *IMX900,
				   struct preisp_hdrae_exp_s *ae)
{
	struct i2c_client *client = IMX900->client;
	u32 l_exp_time, m_exp_time, s_exp_time;
	...
	static int rhs1_old = IMX900_RHS1_X3_DEFAULT;
	static int rhs2_old = IMX900_RHS2_X3_DEFAULT;
	int ret = 0;
	u32 gain_switch = 0;
	u8 cg_mode = 0;
	u32 fsc;
	...
	if (!IMX900->has_init_exp && !IMX900->streaming) {
		IMX900->init_hdrae_exp = *ae;
		IMX900->has_init_exp = true;
		dev_dbg(&IMX900->client->dev, "IMX900 is not streaming, save hdr ae!\n");
		return ret;
	}
	l_exp_time = ae->long_exp_reg;
	m_exp_time = ae->middle_exp_reg;
	...
	if (IMX900->cur_mode->hdr_mode == HDR_X3) {
		//3 stagger
	...
	ret = IMX900_write_reg(client, IMX900_GROUP_HOLD_REG,
		IMX900_REG_VALUE_08BIT, IMX900_GROUP_HOLD_START);
	/* gain effect n+1 */
	ret |= IMX900_write_reg(client, IMX900_LF_GAIN_REG_H,
		IMX900_REG_VALUE_08BIT, IMX900_FETCH_GAIN_H(l_a_gain));
	ret |= IMX900_write_reg(client, IMX900_LF_GAIN_REG_L,
		IMX900_REG_VALUE_08BIT, IMX900_FETCH_GAIN_L(l_a_gain));
	ret |= IMX900_write_reg(client, IMX900_SF1_GAIN_REG_H,
		IMX900_REG_VALUE_08BIT, IMX900_FETCH_GAIN_H(m_a_gain));
	ret |= IMX900_write_reg(client, IMX900_SF1_GAIN_REG_L,
		IMX900_REG_VALUE_08BIT, IMX900_FETCH_GAIN_L(m_a_gain));
	ret |= IMX900_write_reg(client, IMX900_SF2_GAIN_REG_H,
		IMX900_REG_VALUE_08BIT, IMX900_FETCH_GAIN_H(s_a_gain));
	ret |= IMX900_write_reg(client, IMX900_SF2_GAIN_REG_L,
		IMX900_REG_VALUE_08BIT, IMX900_FETCH_GAIN_L(s_a_gain));
	if (gain_switch & 0x100)
		ret |= IMX900_write_reg(client,
			IMX900_GAIN_SWITCH_REG,
			IMX900_REG_VALUE_08BIT,
	...
	//Dynamic adjustment rhs2 must meet the following conditions
	//RHS2(N+1) > (RHS2(N) + BRL �� 3) �C VMAX �� 4) + 3
	...
	ret |= IMX900_write_reg(client,
		IMX900_RHS2_REG_L,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_RHS1_L(rhs2));
	ret |= IMX900_write_reg(client,
		IMX900_RHS2_REG_M,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_RHS1_M(rhs2));
	ret |= IMX900_write_reg(client,
		IMX900_RHS2_REG_H,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_RHS1_H(rhs2));
	/* write SEF2 exposure SHR2 regs*/
	ret |= IMX900_write_reg(client,
		IMX900_SF2_EXPO_REG_L,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_EXP_L(shr2));
	ret |= IMX900_write_reg(client,
		IMX900_SF2_EXPO_REG_M,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_EXP_M(shr2));
	ret |= IMX900_write_reg(client,
		IMX900_SF2_EXPO_REG_H,
		IMX900_REG_VALUE_08BIT,
		IMX900_FETCH_EXP_H(shr2));
	...
	ret |= IMX900_write_reg(client, IMX900_GROUP_HOLD_REG,
		IMX900_REG_VALUE_08BIT, IMX900_GROUP_HOLD_END);
	return ret;
}

static int IMX900_set_conversion_gain(struct IMX900 *IMX900, u32 *cg)
{
	int ret = 0;
	struct i2c_client *client = IMX900->client;
	int cur_cg = *cg;
	...
	if (IMX900->isHCG && cur_cg == GAIN_MODE_LCG) {
		gain_switch = 0x00 | 0x100;
		IMX900->isHCG = false;
	} else if (!IMX900->isHCG && cur_cg == GAIN_MODE_HCG) {
		gain_switch = 0x01 | 0x100;
		IMX900->isHCG = true;
	}
	ret = IMX900_write_reg(client,
	...
	size_t count)
{
	...
	if (!ret && status >= 0 && status < 2)
		IMX900_set_conversion_gain(IMX900, &status);
	else
...
static int IMX900_get_channel_info(struct IMX900 *IMX900, struct rkmodule_channel_info *ch_info)
{
...
static long IMX900_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	...
	case PREISP_CMD_SET_HDRAE_EXP:
		...
		else if (IMX900->cur_mode->hdr_mode == HDR_X3)
	...
	case RKMODULE_SET_HDR_CFG:
		hdr = (struct rkmodule_hdr_cfg *)arg;
		w = IMX900->cur_mode->width;
		h = IMX900->cur_mode->height;
		for (i = 0; i < IMX900->cfg_num; i++) {
			if (w == IMX900->support_modes[i].width &&
			    h == IMX900->support_modes[i].height &&
			    IMX900->support_modes[i].hdr_mode == hdr->hdr_mode) {
				IMX900->cur_mode = &IMX900->support_modes[i];
				break;
			}
		}
		if (i == IMX900->cfg_num) {
			...
			w = IMX900->cur_mode->hts_def - IMX900->cur_mode->width;
			h = IMX900->cur_mode->vts_def - IMX900->cur_mode->height;
			__v4l2_ctrl_modify_range(IMX900->hblank, w, w, 1, w);
			__v4l2_ctrl_modify_range(IMX900->vblank, h,
				IMX900_VTS_MAX - IMX900->cur_mode->height,
				1, h);
			IMX900->cur_vts = IMX900->cur_mode->vts_def;
			pixel_rate = (u32)link_freq_menu_items[IMX900->cur_mode->mipi_freq_idx] / IMX900->cur_mode->bpp * 2 *
				     IMX900->bus_cfg.bus.mipi_csi2.num_data_lanes;
			__v4l2_ctrl_s_ctrl_int64(IMX900->pixel_rate,
						 pixel_rate);
			__v4l2_ctrl_s_ctrl(IMX900->link_freq,
					   IMX900->cur_mode->mipi_freq_idx);
		}
		break;
	case RKMODULE_SET_CONVERSION_GAIN:
		ret = IMX900_set_conversion_gain(IMX900, (u32 *)arg);
		break;
	...
	case RKMODULE_GET_SYNC_MODE:
		sync_mode = (u32 *)arg;
		*sync_mode = IMX900->sync_mode;
		break;
	case RKMODULE_SET_SYNC_MODE:
		sync_mode = (u32 *)arg;
		IMX900->sync_mode = *sync_mode;
		break;
	default:
		ret = -ENOIOCTLCMD;
		break;
				  ...
				  unsigned int cmd, unsigned long arg)
{
	...
	case RKMODULE_GET_CHANNEL_INFO:
		...
		break;
	case RKMODULE_GET_SYNC_MODE:
		ret = IMX900_ioctl(sd, cmd, &sync_mode);
		if (!ret) {
...
static int IMX900_init_conversion_gain(struct IMX900 *IMX900, bool isHCG)
{
	struct i2c_client *client = IMX900->client;
	int ret = 0;
	u32 val = 0;
...
static int __IMX900_start_stream(struct IMX900 *IMX900)
{
	...
	ret = IMX900_write_array(IMX900->client, IMX900->cur_mode->reg_list);
	if (ret)
		return ret;
	ret = IMX900_init_conversion_gain(IMX900, IMX900->isHCG);
	if (ret)
		return ret;
	...
	if (IMX900->sync_mode == EXTERNAL_MASTER_MODE) {
		ret |= IMX900_write_array(IMX900->client, IMX900_external_sync_master_start_regs);
		v4l2_err(&IMX900->subdev, "cur externam master mode\n");
	} else if (IMX900->sync_mode == INTERNAL_MASTER_MODE) {
		ret |= IMX900_write_array(IMX900->client, IMX900_interal_sync_master_start_regs);
		v4l2_err(&IMX900->subdev, "cur intertal master\n");
	} else if (IMX900->sync_mode == SLAVE_MODE) {
		ret |= IMX900_write_array(IMX900->client, IMX900_slave_start_regs);
		v4l2_err(&IMX900->subdev, "cur slave mode\n");
	}
	if (IMX900->sync_mode == NO_SYNC_MODE) {
		ret = IMX900_write_reg(IMX900->client, IMX900_REG_CTRL_MODE,
					IMX900_REG_VALUE_08BIT, IMX900_MODE_STREAMING);
		usleep_range(30000, 40000);
		ret |= IMX900_write_reg(IMX900->client, IMX900_REG_MARSTER_MODE,
...
static int __IMX900_stop_stream(struct IMX900 *IMX900)
{
	...
	if (IMX900->sync_mode == EXTERNAL_MASTER_MODE)
		ret |= IMX900_write_array(IMX900->client, IMX900_external_sync_master_stop_regs);
	else if (IMX900->sync_mode == INTERNAL_MASTER_MODE)
		ret |= IMX900_write_array(IMX900->client, IMX900_interal_sync_master_stop_regs);
	return ret;
}
...
static int IMX900_s_power(struct v4l2_subdev *sd, int on)
{
	...
	if (on) {
		...
		ret = IMX900_write_array(IMX900->client, IMX900_global_regs);
		if (ret) {
...
static inline u32 IMX900_cal_delay(u32 cycles)
{
	return DIV_ROUND_UP(cycles, IMX900_XVCLK_FREQ_54M / 1000 / 1000);
}
...
static int __IMX900_power_on(struct IMX900 *IMX900)
{
	...
	ret = clk_set_rate(IMX900->xvclk, IMX900->cur_mode->mclk);
	if (ret < 0)
		dev_warn(dev, "Failed to set xvclk rate\n");
	if (clk_get_rate(IMX900->xvclk) != IMX900->cur_mode->mclk)
		dev_warn(dev, "xvclk mismatched, %lu\n", clk_get_rate(IMX900->xvclk));
	else
		IMX900->cur_mclk = IMX900->cur_mode->mclk;
	...
	if (!IS_ERR(IMX900->pwdn_gpio))
		gpiod_set_value_cansleep(IMX900->pwdn_gpio, 1);

	/* 8192 cycles prior to first SCCB transaction */
	delay_us = IMX900_cal_delay(8192);
...
static void __IMX900_power_off(struct IMX900 *IMX900)
{
	...
	if (!IS_ERR(IMX900->pwdn_gpio))
		gpiod_set_value_cansleep(IMX900->pwdn_gpio, 0);
	clk_disable_unprepare(IMX900->xvclk);
	if (!IS_ERR(IMX900->reset_gpio))
		gpiod_set_value_cansleep(IMX900->reset_gpio, 0);
...
static int IMX900_runtime_resume(struct device *dev)
{
	struct i2c_client *client = to_i2c_client(dev);
	struct v4l2_subdev *sd = i2c_get_clientdata(client);
	struct IMX900 *IMX900 = to_IMX900(sd);
...
static int IMX900_runtime_suspend(struct device *dev)
{
	struct i2c_client *client = to_i2c_client(dev);
	struct v4l2_subdev *sd = i2c_get_clientdata(client);
	struct IMX900 *IMX900 = to_IMX900(sd);
...
static int IMX900_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
{
	...
	const struct IMX900_mode *def_mode = &IMX900->support_modes[0];
	...
	struct v4l2_subdev_frame_interval_enum *fie)
{
	...
	fie->code = IMX900->support_modes[fie->index].bus_fmt;
	fie->width = IMX900->support_modes[fie->index].width;
	fie->height = IMX900->support_modes[fie->index].height;
	fie->interval = IMX900->support_modes[fie->index].max_fps;
	fie->reserved[0] = IMX900->support_modes[fie->index].hdr_mode;
	return 0;
}
				...
				struct v4l2_subdev_selection *sel)
{
	...
	if (sel->target == V4L2_SEL_TGT_CROP_BOUNDS) {
		sel->r.left = CROP_START(IMX900->cur_mode->width, DST_WIDTH);
		sel->r.width = DST_WIDTH;
		sel->r.top = CROP_START(IMX900->cur_mode->height, DST_HEIGHT);
...
static int IMX900_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_VBLANK:
		...
		if (mode->hdr_mode == NO_HDR) {
			max = IMX900->cur_mode->height + ctrl->val - 3;
			__v4l2_ctrl_modify_range(IMX900->exposure,
						 IMX900->exposure->minimum, max,
	...
	case V4L2_CID_EXPOSURE:
		if (mode->hdr_mode == NO_HDR) {
			shr0 = IMX900->cur_vts - ctrl->val;
			ret = IMX900_write_reg(IMX900->client, IMX900_LF_EXPO_REG_L,
					IMX900_REG_VALUE_08BIT,
					IMX900_FETCH_EXP_L(shr0));
			ret |= IMX900_write_reg(IMX900->client, IMX900_LF_EXPO_REG_M,
					IMX900_REG_VALUE_08BIT,
					IMX900_FETCH_EXP_M(shr0));
			ret |= IMX900_write_reg(IMX900->client, IMX900_LF_EXPO_REG_H,
					IMX900_REG_VALUE_08BIT,
					IMX900_FETCH_EXP_H(shr0));
	...
	case V4L2_CID_ANALOGUE_GAIN:
		if (mode->hdr_mode == NO_HDR) {
			ret = IMX900_write_reg(IMX900->client, IMX900_LF_GAIN_REG_H,
					IMX900_REG_VALUE_08BIT,
					IMX900_FETCH_GAIN_H(ctrl->val));
			ret |= IMX900_write_reg(IMX900->client, IMX900_LF_GAIN_REG_L,
					IMX900_REG_VALUE_08BIT,
	...
	case V4L2_CID_HFLIP:
		ret = IMX900_write_reg(client,
				       ...
				       IMX900_REG_VALUE_08BIT,
				       IMX900_GROUP_HOLD_START);
		ret |= IMX900_write_reg(IMX900->client, IMX900_HREVERSE_REG,
				       IMX900_REG_VALUE_08BIT, !!ctrl->val);
		ret |= IMX900_write_reg(client,
					IMX900_GROUP_HOLD_REG,
					IMX900_REG_VALUE_08BIT,
					IMX900_GROUP_HOLD_END);
	...
	case V4L2_CID_VFLIP:
		...
		ret = IMX900_write_reg(client,
				       ...
				       IMX900_REG_VALUE_08BIT,
				       IMX900_GROUP_HOLD_START);
		ret |= IMX900_write_reg(IMX900->client, IMX900_VREVERSE_REG,
				IMX900_REG_VALUE_08BIT, !!flip);
		if (flip) {
			ret |= IMX900_write_reg(IMX900->client, 0x3074,
				IMX900_REG_VALUE_08BIT, 0x40);
			ret |= IMX900_write_reg(IMX900->client, 0x3075,
				IMX900_REG_VALUE_08BIT, 0x06);
			ret |= IMX900_write_reg(IMX900->client, 0x3080,
				IMX900_REG_VALUE_08BIT, 0xff);
			ret |= IMX900_write_reg(IMX900->client, 0x30ad,
				IMX900_REG_VALUE_08BIT, 0x7e);
			ret |= IMX900_write_reg(IMX900->client, 0x30b6,
				IMX900_REG_VALUE_08BIT, 0xff);
			ret |= IMX900_write_reg(IMX900->client, 0x30b7,
				IMX900_REG_VALUE_08BIT, 0x01);
			ret |= IMX900_write_reg(IMX900->client, 0x30d8,
				IMX900_REG_VALUE_08BIT, 0x45);
			ret |= IMX900_write_reg(IMX900->client, 0x3114,
				IMX900_REG_VALUE_08BIT, 0x01);
		} else {
			ret |= IMX900_write_reg(IMX900->client, 0x3074,
				IMX900_REG_VALUE_08BIT, 0x3c);
			ret |= IMX900_write_reg(IMX900->client, 0x3075,
				IMX900_REG_VALUE_08BIT, 0x00);
			ret |= IMX900_write_reg(IMX900->client, 0x3080,
				IMX900_REG_VALUE_08BIT, 0x01);
			ret |= IMX900_write_reg(IMX900->client, 0x30ad,
				IMX900_REG_VALUE_08BIT, 0x02);
			ret |= IMX900_write_reg(IMX900->client, 0x30b6,
				IMX900_REG_VALUE_08BIT, 0x00);
			ret |= IMX900_write_reg(IMX900->client, 0x30b7,
				IMX900_REG_VALUE_08BIT, 0x00);
			ret |= IMX900_write_reg(IMX900->client, 0x30d8,
				IMX900_REG_VALUE_08BIT, 0x44);
			ret |= IMX900_write_reg(IMX900->client, 0x3114,
				IMX900_REG_VALUE_08BIT, 0x02);
		}
		ret |= IMX900_write_reg(client,
...
static int IMX900_initialize_controls(struct IMX900 *IMX900)
{
	...
	IMX900->link_freq = v4l2_ctrl_new_int_menu(handler,
	...
	pixel_rate = (u32)link_freq_menu_items[mode->mipi_freq_idx] / mode->bpp * 2 *
		     IMX900->bus_cfg.bus.mipi_csi2.num_data_lanes;
	IMX900->pixel_rate = v4l2_ctrl_new_std(handler, NULL,
		V4L2_CID_PIXEL_RATE, 0, IMX900_10BIT_HDR2_PIXEL_RATE,
		1, pixel_rate);
	...
	IMX900->exposure = v4l2_ctrl_new_std(handler, &IMX900_ctrl_ops,
				V4L2_CID_EXPOSURE, IMX900_EXPOSURE_MIN,
				exposure_max, IMX900_EXPOSURE_STEP,
				mode->exp_def);

	IMX900->anal_a_gain = v4l2_ctrl_new_std(handler, &IMX900_ctrl_ops,
				V4L2_CID_ANALOGUE_GAIN, IMX900_GAIN_MIN,
				IMX900_GAIN_MAX, IMX900_GAIN_STEP,
				IMX900_GAIN_DEFAULT);
	v4l2_ctrl_new_std(handler, &IMX900_ctrl_ops, V4L2_CID_HFLIP, 0, 1, 1, 0);
	v4l2_ctrl_new_std(handler, &IMX900_ctrl_ops, V4L2_CID_VFLIP, 0, 1, 1, 0);
			...
			const struct i2c_device_id *id)
{
	...
	if (IMX900->bus_cfg.bus.mipi_csi2.num_data_lanes == 4) {
		IMX900->support_modes = supported_modes;
		IMX900->cfg_num = ARRAY_SIZE(supported_modes);
	} else {
		IMX900->support_modes = supported_modes_2lane;
		IMX900->cfg_num = ARRAY_SIZE(supported_modes_2lane);
	}

	for (i = 0; i < IMX900->cfg_num; i++) {
		if (hdr_mode == IMX900->support_modes[i].hdr_mode) {
			IMX900->cur_mode = &IMX900->support_modes[i];
			break;
		}
	}
	IMX900->cur_mode = &IMX900->support_modes[0];
	...
	IMX900->pwdn_gpio = devm_gpiod_get(dev, "pwdn", GPIOD_OUT_LOW);
	if (IS_ERR(IMX900->pwdn_gpio))
	...
	snprintf(sd->name, sizeof(sd->name), "m%02d_%s_%s %s",
		 IMX900->module_index, facing,
		 IMX900_NAME, dev_name(sd->dev));
