...
static const struct vc_mipi_sen_reg imx296_init_tab_1440_1080_60fps[] = {
	{ 0x30af,
	  0x08 }, // Fix Output position of FE code when using Fast trigger
	{ VC_MIPI_REG_TABLE_END, 0x00 }
};
...
static const struct vc_mipi_sen_reg start_unknown[] = { { VC_MIPI_REG_TABLE_END,
							  0x00 } };

static const struct vc_mipi_sen_reg stop_unknown[] = { { VC_MIPI_REG_TABLE_END,
							 0x00 } };
...
#define str_imx_model(model)                                                   \
	...
	(IMX296_MODEL_MONOCHROME_S == (model)) ?                               \
					  ("IMX296, monochrome stereo") :      \
...
#define imx_model_by_mod_id(mod_id, color, stereo)                             \
	(0x290 == (mod_id)) ?                                                  \
		((color) ? (IMX290_MODEL_COLOR) : (IMX290_MODEL_MONOCHROME)) : \
	(0x296 == (mod_id)) ?                                                  \
		((stereo) ? ((color) ? (IMX296_MODEL_COLOR_S) :                \
				       (IMX296_MODEL_MONOCHROME_S)) :          \
			    ((color) ? ((color == 2) ? IMX296_MODEL_COLOR_R :  \
						       IMX296_MODEL_COLOR) :   \
				       (IMX296_MODEL_MONOCHROME))) :           \
	(0x297 == (mod_id)) ?                                                  \
		((color) ? (IMX297_MODEL_COLOR) : (IMX297_MODEL_MONOCHROME)) : \
	(0x327 == (mod_id)) ?                                                  \
		((color) ? (IMX327_MODEL_COLOR) : (IMX327_MODEL_MONOCHROME)) : \
	(0x412 == (mod_id)) ?                                                  \
		((color) ? (IMX412_MODEL_COLOR) : (IMX412_MODEL_MONOCHROME)) : \
	(0x9281 == (mod_id)) ?                                                 \
		((color) ? (OV9281_MODEL_COLOR) : (OV9281_MODEL_MONOCHROME)) : \
	(0x183 == (mod_id)) ?                                                  \
		((color) ? (IMX183_MODEL_COLOR) : (IMX183_MODEL_MONOCHROME)) : \
	(0x273 == (mod_id)) ?                                                  \
		((color) ? (IMX273_MODEL_COLOR) : (IMX273_MODEL_MONOCHROME)) : \
	(0x226 == (mod_id)) ?                                                  \
		((color) ? (IMX226_MODEL_COLOR) : (IMX226_MODEL_MONOCHROME)) : \
	(0x415 == (mod_id)) ?                                                  \
		((color) ? (IMX415_MODEL_COLOR) : (IMX415_MODEL_MONOCHROME)) : \
	(0x252 == (mod_id)) ?                                                  \
		((color) ? (IMX252_MODEL_COLOR) : (IMX252_MODEL_MONOCHROME)) : \
	(0x7251 == (mod_id)) ?                                                 \
		((color) ? (OV7251_MODEL_COLOR) : (OV7251_MODEL_MONOCHROME)) : \
	(0x250 == (mod_id)) ?                                                  \
		((color) ? (IMX250_MODEL_COLOR) : (IMX250_MODEL_MONOCHROME)) : \
	(0x392 == (mod_id)) ?                                                  \
		((color) ? (IMX392_MODEL_COLOR) : (IMX392_MODEL_MONOCHROME)) : \
	(0x178 == (mod_id)) ?                                                  \
		((color) ? (IMX178_MODEL_COLOR) : (IMX178_MODEL_MONOCHROME)) : \
	(0x264 == (mod_id)) ?                                                  \
		((color) ? (IMX264_MODEL_COLOR) : (IMX264_MODEL_MONOCHROME)) : \
	(0x335 == (mod_id)) ?                                                  \
		((color) ? (IMX335_MODEL_COLOR) : (IMX335_MODEL_MONOCHROME)) : \
	(0x265 == (mod_id)) ?                                                  \
		((color) ? (IMX265_MODEL_COLOR) : (IMX265_MODEL_MONOCHROME)) : \
	(0x462 == (mod_id)) ?                                                  \
		((color) ? (IMX462_MODEL_COLOR) : (IMX462_MODEL_MONOCHROME)) : \
	(0x568 == (mod_id)) ?                                                  \
		((color) ? (IMX568_MODEL_COLOR) : (IMX568_MODEL_MONOCHROME)) : \
	(0x567 == (mod_id)) ?                                                  \
		((color) ? (IMX568_MODEL_COLOR) : (IMX568_MODEL_MONOCHROME)) : \
	(0x565 == (mod_id)) ?                                                  \
		((color) ? (IMX565_MODEL_COLOR) : (IMX565_MODEL_MONOCHROME)) : \
	(0x566 == (mod_id)) ?                                                  \
		((color) ? (IMX566_MODEL_COLOR) : (IMX566_MODEL_MONOCHROME)) : \
	(0x900 == (mod_id)) ?                                                  \
		((color) ? (IMX900_MODEL_COLOR) : (IMX900_MODEL_MONOCHROME)) : \
	(0x585 == (mod_id)) ?                                                  \
		((color) ? (IMX585_MODEL_COLOR) : (IMX585_MODEL_MONOCHROME)) : \
		(IMX_MODEL_UNKNOWN)
